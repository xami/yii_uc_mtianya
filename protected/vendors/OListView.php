 ...
 * @since 1.1
 */
class OListView extends CBaseListView
{
    /**
...
//        echo CHtml::tag('span', array('class'=>'empty'), '正在更新，请刷新......').Tianya::link468x15().Tianya::ad336x280().Tianya::link468x15();
