<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/network|template/default/header|template/default/footer', '1348306334', 'template/default/network');?><?php $_TPL['nosidebar']=1; ?>
...
<p class="gray"><a href="space.php?uid=<?=$value['uid']?>"><?=$_SN[$value['uid']]?></a> 发表于 <?php echo sgmdate('m-d H:item',$value[dateline],1); ?></p>
</li>
<?php } } ?>
</ul>
</div>
...
<li>
<p>
<a href="space.php?uid=<?=$value['uid']?>&do=doing&doid=<?=$value['doid']?>" target="_blank" class="gray r_option dot" style="margin:0;background-position-y: 0;"><?php echo sgmdate('H:item',$value[dateline],1); ?></a>
...
<p><?php echo sgmdate('m-d H:item',$value[dateline],1); ?></p>
</li>
<?php } } ?>
</ul>
</div>
...
<p>更新: <?php echo sgmdate('H:item',$value[updatetime],1); ?></p>
</div>
<?php } } ?>
</div>
...
<p><span class="gray">时间:</span> <?php echo sgmdate('n-j H:item',$value[starttime]); ?> - <?php echo sgmdate('n-j H:item',$value[endtime]); ?></p>
