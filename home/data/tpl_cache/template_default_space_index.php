<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_index|template/default/header|template/default/space_status|template/default/space_feed_li|template/default/space_comment_li|template/default/footer', '1347289275', 'template/default/space_index');?><?php $_TPL['nosidebar']=1; ?>
...
<h4>
<span class="gray r_option"><?php echo sgmdate('m-d H:item',$value[dateline],1); ?></span>
...
匿名
<?php } ?>
<span class="gray"><?php echo sgmdate('Y-m-d H:item',$value[dateline],1); ?></span>
