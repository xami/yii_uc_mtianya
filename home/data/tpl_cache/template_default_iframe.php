<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/iframe', '1348305861', 'template/default/iframe');?><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
...
<span class="gray"><?php echo sgmdate('Y-m-d H:item',$_SGLOBAL[timestamp],1); ?></span>
</div>
<div class="feed">
