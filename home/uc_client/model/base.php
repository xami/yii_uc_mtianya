...
class base {
	 ...
	 *
	 * @param int $time
	 * @param int $type 	1��ֻ��ʾʱ�� 2��ֻ��ʾ���� 3������ʱ�����ʾ
	 * @return string
	 */
	function date($time, $type = 3) {
		...
		$format[] = $type & 1 ? (!empty($this->settings['timeformat']) ? $this->settings['timeformat'] : 'H:item') : '';
	 ...
	 * ���ַ��������Ӷ�������, ����
	 *
	 * @param string/array $arr ���Դ������ֻ����ִ�
	 * @return string ����ĸ�ʽ: '1','2','3'
	 */
	 ...
	 *
	 * @param string $k ���õ���
	 * @param string $decode �Ƿ���з����л���һ��Ϊ����ʱ����Ҫָ��ΪTRUE
	 * @return string/array ���õ�ֵ
	 */
