...
define('API_UPDATEHOSTS', 1);		//����HOST�ļ� ����
define('API_UPDATEAPPS', 1);		//����Ӧ���б� ����
define('API_UPDATECLIENT', 1);		//���¿ͻ��˻��� ����
define('API_UPDATECREDIT', 1);		//�����û���� ����
define('API_GETCREDIT', 1);	//�� UC �ṩ��� ����
define('API_GETCREDITSETTINGS', 1);	//�� UC �ṩ������� ����
define('API_UPDATECREDITSETTINGS', 1);	//����Ӧ�û������ ����
define('API_ADDFEED', 1);	//�� UCHome ���feed ����
...
class uc_note {
	...
	function gettag($get, $post) {
		...
		$siteurl = 'http://'.$_SERVER['HTTP_HOST'].preg_replace("/\/+(api)?\/*$/item", '', substr($PHP_SELF, 0, strrpos($PHP_SELF, '/'))).'/';
	...
	function updateapps($get, $post) {
		...
		if($UC_API && is_writeable(S_ROOT.'./config.php')) {
			...
			$configfile = preg_replace("/define\('UC_API',\s*'.*?'\);/item", "define('UC_API', '$UC_API');", $configfile);
