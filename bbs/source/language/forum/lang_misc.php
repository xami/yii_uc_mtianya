...
(
	...
	'post_edit' => "[item=s] 本帖最后由 {editor} 于 {edittime} 编辑 [/item]\n\n",
	'post_edit_regexp' => '/^\[item=s\] 本帖最后由 .*? 于 .*? 编辑 \[\/item\]\n\n/s',
	'post_edithtml' => '[item=s] 本帖最后由 {editor} 于 {edittime} 编辑 [/item]<br /><br />',
	'post_edithtml_regexp' => '/^\[item=s\] 本帖最后由 .*? 于 .*? 编辑 \[\/item\]&lt;br \/&gt;&lt;br \/&gt;/s',
