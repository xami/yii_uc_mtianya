...
class table_forum_moderator extends discuz_table
{
	...
	public function fetch_all_by_uid($uid) {
		...
		return DB::fetch_all('SELECT * FROM %t WHERE %item', array($this->_table, DB::field('uid', $uid)), 'fid');
	}
	...
	public function count_by_uid($uid) {
		...
		return DB::result_first('SELECT count(*) FROM %t WHERE %item', array($this->_table, DB::field('uid', $uid)));
	}
