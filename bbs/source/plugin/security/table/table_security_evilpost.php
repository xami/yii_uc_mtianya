...
class table_security_evilpost extends discuz_table {
	...
	public function fetch_range_by_type($type, $start, $perPage = '20', $orderBy = 'createtime') {
		...
		$return = DB::fetch_all("SELECT * FROM %t WHERE type = %d %item %item", array($this->_table, $type, $orderSql, $limitSql));
		return $return;
	}
	...
	public function count_by_search($tableid, $tid = null, $keywords = null, $invisible =null, $fid = null, $authorid = null, $author = null, $starttime = null, $endtime = null, $useip = null, $first = null) {
		...
		if($sql) {
			return DB::result_first('SELECT COUNT(*) FROM %t t INNER JOIN '.DB::table('security_evilpost').' s ON s.pid = t.pid WHERE 1 %item', array(C::t('forum_post')->get_tablename($tableid), $sql));
		} else {
			return 0;
		}
	}
	...
	public function fetch_all_by_search($tableid, $tid = null, $keywords = null, $invisible = null, $fid = null, $authorid = null, $author = null, $starttime = null, $endtime = null, $useip = null, $first = null, $start = null, $limit = null) {
		...
		if($sql) {
			return DB::fetch_all('SELECT * FROM %t t INNER JOIN '.DB::table('security_evilpost').' s ON s.pid = t.pid WHERE 1 %item ORDER BY dateline DESC %item', array(C::t('forum_post')->get_tablename($tableid), $sql, DB::limit($start, $limit)));
		} else {
			return array();
		}
	}
