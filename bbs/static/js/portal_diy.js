...
drag.extend({
	...
	openStyleEdit : function (e) {
		...
		html = '<div class="channel diywin" style="width:450px;position:relative;">'+table+'</div>';
	...
	openTitleEdit : function (e) {
		...
		var c = len + 1;
			html = '<div class="channel diywin" style="width:450px;height:400px; overflow:auto;"><table cellspacing="0" cellpadding="0" class="tfm pns"><tr><th></th><td><button type="button" id="addTitleInput" class="pn" onclick="drag.addTitleInput('+c+');"><em>添加新标题</em></button></td></tr></table><div id="titleEdit">'+html+common+'</div></div>';
